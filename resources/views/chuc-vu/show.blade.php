            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title mb-0">
                        <i class="fas fa-user-tie"></i> Chi tiết Chức vụ
                    </h3>
                    <div>
                        <a href="{{ route('chuc-vu.edit', $chucVu) }}" class="btn btn-warning">
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-primary fs-6">{{ $chucVu->ten_chuc_vu }}</span></td>
                                </tr>
                                <tr>
                                    <td><strong>Ngày tạo:</strong></td>
                                    <td>{{ $chucVu->created_at->format('d/m/Y H:i') }}</td>
                                </tr>
                                <tr>
                                    <td><strong>Cập nhật lần cuối:</strong></td>
                                    <td>{{ $chucVu->updated_at->format('d/m/Y H:i') }}</td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        <i class="fas fa-users text-success"></i> Nhân sự có chức vụ này
                    </h5>
                </div>
                <div class="card-body">
                    <div class="text-center mb-3">
                        <h2 class="text-primary">{{ $chucVu->nhanSu->count() }}</h2>
                    ...
                    @if($chucVu->nhanSu->count() > 0)
                        ...
                        <div class="list-group list-group-flush">
                            @foreach($chucVu->nhanSu->take(5) as $nhanSu)
                            ...
                            @if($chucVu->nhanSu->count() > 5)
                                <div class="list-group-item px-0 py-2 text-center">
                                    <small class="text-muted">và {{ $chucVu->nhanSu->count() - 5 }} nhân viên khác...</small>
                                </div>
                            @endif
                        </div>
                        
                        <div class="mt-3">
                            <a href="{{ route('nhan-su.index', ['chuc_vu' => $chucVu->id]) }}" 
                    ...
                    @else
                        <div class="text-center text-muted">
                            ...
                            <p>Chưa có nhân viên nào có chức vụ này</p>
                        </div>
                    @endif
                </div>
            </div>
                        ...
                        @if($chucVu->nhanSu->count() == 0)
                            <form action="{{ route('chuc-vu.destroy', $chucVu) }}" 
                                ...
                                <button type="submit" class="btn btn-danger w-100">
                                    <i class="fas fa-trash"></i> Xóa chức vụ
                                </button>
                            </form>
                        @else
