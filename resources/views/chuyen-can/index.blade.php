...
<div class="container mx-auto px-4 sm:px-8">
    <div class="py-8">
        ...
        <div class="my-2 flex sm:flex-row flex-col">
            <form method="GET" action="{{ route('chuyen-can.index') }}" class="flex flex-row mb-1 sm:mb-0">
                <div class="relative">
                ...
                <div class="block relative">
                    <button type="submit"
                        class="h-full w-full flex items-center justify-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-r sm:rounded-r-md">
                        Lọc
                    </button>
                </div>
            </form>
                    ...
                    <tbody>
                        @forelse ($chuyenCanData as $data)
                            <tr>
                                ...
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <p class="text-gray-900 whitespace-no-wrap">{{ $data['thang'] }}/{{ $data['nam'] }}</p>
                                </td>
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <p class="text-gray-900 whitespace-no-wrap">{{ $data['so_cong'] }}</p>
                                </td>
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
