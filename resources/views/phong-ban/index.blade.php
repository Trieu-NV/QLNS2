        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title mb-0">Danh sách Phòng ban</h3>
                ...
                <div class="card-body">
                    ...
                    <form method="GET" action="{{ route('phong-ban.index') }}" class="mb-3">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-3">
                                <select name="sort_by" class="form-select">
                                    ...
                                    <option value="ten_phong_ban" {{ request('sort_by') == 'ten_phong_ban' ? 'selected' : '' }}>Tên phòng ban</option>
                                </select>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-1">
                                <a href="{{ route('phong-ban.index') }}" class="btn btn-outline-secondary w-100">
                            ...
                            <tbody>
                                @forelse($phongBans as $index => $phongBan)
                                    <tr>
                                        ...
                                        <td>
                                            <strong>{{ $phongBan->ten_phong_ban }}</strong>
                                        </td>
                                        <td>
                                            {{ $phongBan->mo_ta ? Str::limit($phongBan->mo_ta, 100) : 'Chưa có mô tả' }}
                                        </td>
                                        <td>
                                            <span class="badge bg-info">{{ $phongBan->nhan_su_count ?? 0 }} người</span>
                                        </td>
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <a href="{{ route('phong-ban.edit', $phongBan) }}" 
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center py-4">
                                            ...
                                            <p class="text-muted">Không có dữ liệu phòng ban nào.</p>
                                            <a href="{{ route('phong-ban.create') }}" class="btn btn-primary">
